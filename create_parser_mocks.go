...
func (m *MockTokenParser) ParseToken(accessToken string) (Token, error) {
	m.ctrl.T.Helper()
...
func (m *MockTokenCreator) CreateToken(payload Payload) (string, error) {
	m.ctrl.T.Helper()
...
// CreateToken mocks base method.
func (m *MockTokenCreateParser) CreateToken(payload Payload) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateToken", payload)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
...
// ParseToken mocks base method.
func (m *MockTokenCreateParser) ParseToken(accessToken string) (Token, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseToken", accessToken)
	ret0, _ := ret[0].(Token)
	ret1, _ := ret[1].(error)
